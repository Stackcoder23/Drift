...
<body ng-app="myApp" ng-controller="listingCtrl">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
           ...
           <div class="container-fluid" ng-controller="listingCtrl" ng-init="loadList()">
    <center><strong><h1>Users list</h1></strong></center>    
    <br>
    <br>
    <div id="body">
        <h4>
 ...
 <script type="text/javascript" src="<?php echo base_url();?>assets/admin/js/userlistingCtrl.js"></script>      
