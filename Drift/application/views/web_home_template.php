    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <center><img class="img-responsive" src="<?php echo base_url()?>images/logo.png" alt="logo" height="50px">Taste That last forever!!!</center>
       <ul class="nav navbar-nav navbar-right">
        <li><a href="<?=base_url()?>website/display_items">Home</a></li>
        <li><a href="<?=base_url()?>website/order_history">order history</a></li>
      
         <li><a href="<?=base_url()?>website/logout">logout</a></li>
      </ul>
    </div>
  </div>
</nav>
