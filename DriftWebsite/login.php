...
if(isset($_POST["button1"]))
{
  ...
  $sql = "SELECT userid FROM customer WHERE email = '$username' and password = '$password'";
...
<body>
  ...
  <form id="login_form" action="" method="post">
    ...
    <div class="field_container"> 
      ...
      <br>
      <button style="margin: auto; display: block; margin-top: 5%;" id="sign_in_button" name="button1">
